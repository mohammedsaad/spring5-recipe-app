...
create table recipe (id bigint not null auto_increment, cook_time integer, description longtext, difficulty varchar(255), direction longtext, image longblob, prep_time integer, servings integer, source varchar(255), url varchar(255), primary key (id)) engine=InnoDB
